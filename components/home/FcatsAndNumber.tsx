            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        Discover the impressive statistics that make our institution a leader in education
                        and innovation. These numbers represent our commitment to excellence and the
                    ...
                    {FactsAndNumbers.map((stat) => (
                        ...
                        >
                            ...
                            <div className='flex flex-col items-center justify-center'>
                                {/* Icon */}
                                <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${stat.color} text-white mb-6 group-hover:scale-110 transition-transform duration-300`}>
                                ...
                                <div className="mb-4">
                                    <span className="text-4xl md:text-5xl font-bold text-gray-900">
                                        {stat.id === 6 ? (counts[stat.id] || 0).toFixed(1) : counts[stat.id] || 0}
                                    </span>
                                    {stat.id === 6 && <span className="text-2xl text-gray-600">/5</span>}
                                    {stat.id === 4 && <span className="text-2xl text-gray-600">%</span>}
                                    {stat.id === 5 && <span className="text-2xl text-gray-600">+</span>}
                                </div>
