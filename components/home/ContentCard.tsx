...
import { Calendar, Clock, MapPin, Users, User, BookOpen, Star, ArrowRight } from 'lucide-react'
...
const ContentCard: React.FC<ContentCardProps> = ({ item, type, className = '' }) => {
    ...
    return (
        <Card className={`group overflow-hidden bg-white hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 ${className}`}>
