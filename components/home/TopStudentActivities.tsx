...
import { topStudentActivitiesData } from '@/data';
import ExpandableContentCard from './ExpandableContentCard';

function TopStudentActivities() {
  return (
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-12'>
          <div className='flex items-center justify-center mb-4'>
            <Users className='w-8 h-8 text-[#023e8a] mr-3' />
            <h2 className='text-4xl md:text-5xl font-bold text-gray-900'>
              {topStudentActivitiesData.title}
            </h2>
          </div>
          <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
            {topStudentActivitiesData.subtitle}
          </p>
        </div>

        {/* Activities Expandable Cards */}
        <ExpandableContentCard
          items={topStudentActivitiesData.items}
          type='activity'
          className='space-y-4'
        />
...
export default TopStudentActivities;
