        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
          {items.map((program, index) => (
            <Reveal key={program.id} delayMs={index * 80} from='up'>
              <article className='group relative bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl transition-all overflow-hidden hover:-translate-y-1 ring-1 ring-transparent hover:ring-[#023e8a]/40'>
