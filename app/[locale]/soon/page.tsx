...
import { Mail, Clock, Calendar, Send, University, BookOpen, Users, Globe } from 'lucide-react';
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12 text-center">
        ...
        >
          ...
          >
            We&apos;re working hard to bring you an incredible new experience. Our team is putting the finishing touches on a revolutionary platform that will transform education.
          </motion.p>
          ...
          >
            <div className="p-4 bg-blue-800/30 backdrop-blur-sm rounded-xl border border-blue-700/30">
              <div className="text-3xl font-bold text-white sm:text-4xl">{timeLeft.days}</div>
              <div className="text-sm text-blue-200">Days</div>
            </div>
            <div className="p-4 bg-blue-800/30 backdrop-blur-sm rounded-xl border border-blue-700/30">
              <div className="text-3xl font-bold text-white sm:text-4xl">{timeLeft.hours}</div>
              <div className="text-sm text-blue-200">Hours</div>
            </div>
            <div className="p-4 bg-blue-800/30 backdrop-blur-sm rounded-xl border border-blue-700/30">
              <div className="text-3xl font-bold text-white sm:text-4xl">{timeLeft.minutes}</div>
              <div className="text-sm text-blue-200">Minutes</div>
            </div>
            <div className="p-4 bg-blue-800/30 backdrop-blur-sm rounded-xl border border-blue-700/30">
              <div className="text-3xl font-bold text-white sm:text-4xl">{timeLeft.seconds}</div>
          ...
          >
            <h3 className="mb-4 text-xl font-semibold text-white">Get notified when we launch</h3>
          ...
          >
            ...
            Expected Launch: {new Date().getDate() + 30}/{new Date().getMonth() + 1}/{new Date().getFullYear()}
          </motion.div>
        </motion.div>
      </div>
      ...
      >
        <p className="text-sm text-blue-300/70">© {new Date().getFullYear()} Helwan National University. All rights reserved.</p>
      </motion.div>
    </div>
  );
}